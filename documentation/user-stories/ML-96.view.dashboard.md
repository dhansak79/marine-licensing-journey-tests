...
Dashboard empty state showing "Projects" heading followed by the message "You currently have no projects." The page maintains the same header structure with "Get permission for a marine activity" service name and navigation links.
