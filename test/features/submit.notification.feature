@issue=ML-1 @issue=ML-9 @issue=ML-10 @issue=ML-11 @issue=ML-12 @issue=ML-16 @issue=ML-17 @issue=ML-18 @issue=ML-21 @issue=ML-35 @issue=ML-36 @issue=ML-37 @issue=ML-82 @issue=ML-84 @issue=ML-715
Feature: Submit exemption notification: A unique reference number is generated for the notification and the notification is submitted.
  ...
  - ML-715: The user is able to access the feedback survey from the confirmation page
